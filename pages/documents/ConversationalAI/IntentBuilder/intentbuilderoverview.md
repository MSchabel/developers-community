...
A "prebuilt domain" is a ready-made, pretrained domain that includes a set of well-defined, predefined intents. There are two kinds of prebuilt domains available:
